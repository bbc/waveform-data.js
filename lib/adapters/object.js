...
WaveformDataObjectAdapter.prototype = {
   ...
   *
   * **Notice**: currently the adapter only deals with 8-bit encoded data.
   * You should favor that too because of the smaller data network fingerprint.
   *
   * @return {boolean} True if data are declared to be 8-bit encoded.
   */
  ...
  /**
   * Indicates if the response body is encoded in 16 bits.
   *
   * @return {boolean} True if data are declared to be 16-bit encoded.
   */
