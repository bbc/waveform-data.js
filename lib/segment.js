...
WaveformDataSegment.prototype = {
  ...
  get min() {
    return this.visible ? this.context._offsetValues(this.offset_start, this.offset_length, 0) : [];
  },
  ...
  get max() {
    return this.visible ? this.context._offsetValues(this.offset_start, this.offset_length, 1) : [];
  }
};
