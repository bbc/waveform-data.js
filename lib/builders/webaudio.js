/* globals define, AudioContext */
define('web-audio-builder', [
    'waveform-data'
 ...
 * @constructor
 */
webAudioBuilder.fromAudioObject = WaveformData.adapters.arraybuffer.fromAudioObject = function fromAudioObjectBuilder(raw_response, callback){
