...
function createFromAudio(options, callback) {
  ...
  if (options.audioContext && options.arrayBuffer) {
    return createFromArrayBuffer(options.audioContext, options.arrayBuffer, opts, callback);
  }
  else if (options.audioBuffer) {
    return createFromAudioBuffer(options.audioBuffer, opts, callback);
  }
  else {
