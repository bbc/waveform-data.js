...
WaveformData.prototype = {
  ...
  resample: function(options){
    ...
    options.from = 'from' in options ? options.from : 0;
    options.to = 'to' in options ? options.to : this.adapter.length / 2;
