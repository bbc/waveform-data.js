...
WaveformData.prototype = {
  ...
  resample: function(options){
    ...
    var min = input_buffer_size ? this.min_sample(options.input_index) : 0; //min value for peak in waveform
    var max = input_buffer_size ? this.max_sample(options.input_index) : 0; //max value for peak in waveform
