...
var WaveformDataObjectAdapter = require("../../../lib/adapters/object");
var fixtures = require("../../fixtures");
var expect = require("chai").expect;

describe("WaveformDataObjectAdapter", function() {
  var instance;
  ...
  context("with a single channel 8-bit data file", function() {
    beforeEach(function() {
      ...
      instance = new WaveformDataObjectAdapter(data);
    });
  ...
  context("with a single channel 16-bit data file", function() {
    beforeEach(function() {
      const data = fixtures.getJSONData({ channels: 1, bits: 16 });
  ...
  context("with a two-channel 16-bit data file", function() {
    beforeEach(function() {
      const data = fixtures.getJSONData({ channels: 2, bits: 16 });
